...
\author{Carnation, with Claude (Anthropic)}
\date{March 30, 2026}
...
\midrule
1 & Mar 28 AM & GPU bucket\_sum, GLV, merged CB & 3850$\to$1050ms \\
2 & Mar 28 PM & skip\_imbalance, parallel Shplonk & 1050ms stable \\
3 & Mar 28 PM & GPU sort, DontZeroMemory, prewarm & 1550$\to$1466ms \\
4 & Mar 28 EVE & Count-sorted reduce, overlap & $\sim$380ms (small) \\
5--7 & Mar 29 AM & GPU GLV, 512-seg combine & 165$\to$85ms MSM \\
8 & Mar 29 PM & Async Metal init, prewarm & $\sim$300ms (small) \\
9 & Mar 29 PM & GPU-only preconvert, spin-wait & $\sim$240ms (small) \\
10 & Mar 29 PM & Fused gather-reduce & 1790$\to$1452ms \\
11 & Mar 29 EVE & Fixed SIGSEGV, dead code, LTO & $\sim$310ms / $\sim$1.3s \\
12 & Mar 30 & Timing removal & $\sim$3--5\% PCS \\
\bottomrule
\end{tabular}
